...
amazonPicks:
  - search: monitor 27 pulgadas 4k para escritura
    title: Monitor vertical o 27" 4K
    note: Trabajar con documentos largos en un panel pequeño es el mayor cuello de botella real.
    price: 249
  - search: On Writing Well libro
    title: Libros de estilo y escritura
    note: La IA no te enseña criterio. Estos manuales sí, y se nota en cómo diriges la herramienta.
    price: 18
accent: accent
featured: true
pubDate: 2026-03-02
...
| --- | --- |
| Textos publicables en español | Claude |
| Documentos muy largos | Claude |
| Análisis de hojas de cálculo | ChatGPT |
